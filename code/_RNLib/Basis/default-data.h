...
public:
	...
	enum class MODEL    { CUBE, SPHERE, DOME_UP, DOME_DOWN, PYRAMID_ALLOW, LINEAR_LIGHT, OBSERVER, MONITOR, PRUFEN_HEAD, PRUFEN_BODY, PRUFEN_LIMB_UP, PRUFEN_LIMB_DOWN, PRUFEN_LIMB_LEFT, PRUFEN_LIMB_RIGHT, MAX, };
