...
public:
	...
	void      SetEditDollDrawModelVtxIdxNum    (const UShort& drawModelVtxIdxNum)     { m_editInfo.drawModelVtxIdxNum = drawModelVtxIdxNum; }
	UShort&   GetEditDollDrawModelVtxIdxNum    (void)                                 { return m_editInfo.drawModelVtxIdxNum; }
