...
const CBlock::LooksData CBlock::LOOKS_DATAS[(int)LOOKS_TYPE::MAX] = {
	...
	{ "data\\MODEL\\StageObject\\Leaf.x"                      , "NONEDATA"                                       , Color(255,255,255,255), MODEL_TYPE::PUT          , SET_TYPE::NONE                ,  0.0f  , 0.0f , },	  // 草ブロック
	...
	{ "NONEDATA"                                              , "NONEDATA"                                       , Color(255,255,255,255), MODEL_TYPE::PUT          , SET_TYPE::NONE                , -16.0f , 0.0f , },	  // バオバブの木(背景用)
	{ "NONEDATA"                                              , "NONEDATA"                                       , Color(255,255,255,255), MODEL_TYPE::PUT          , SET_TYPE::NONE                ,  0.0f  , 0.0f , },	  // 宝箱
	{ "data\\MODEL\\coin.x"                                   , "NONEDATA"                                       , Color(255,255,255,255), MODEL_TYPE::MESH         , SET_TYPE::FORWARD             , -8.0f  , 0.0f , },	  // 山積みのコイン
	{ "data\\MODEL\\stone_monument.x"                         , "NONEDATA"                                       , Color(255,255,255,255), MODEL_TYPE::PUT          , SET_TYPE::NONE                ,  0.0f  , 0.0f , },	  // 謎の石碑
	...
	{ "NONEDATA"                                              , "NONEDATA"                                       , Color(255,255,255,255), MODEL_TYPE::PUT          , SET_TYPE::NONE                , -8.0f  , 0.0f , },	  // ヤシの木
	{ "data\\MODEL\\Three-eyes_block.x"                       , "NONEDATA"                                       , Color(255,255,255,255), MODEL_TYPE::PUT          , SET_TYPE::NONE                ,  0.0f  , 0.0f , },	  // 三つ目のブロック
	{ "data\\MODEL\\StageObject\\Leaf_Nuts.x"                 , "NONEDATA"                                       , Color(255,255,255,255), MODEL_TYPE::PUT          , SET_TYPE::NONE                ,  0.0f  , 0.0f , },	  // 草ブロック(木の実)
	...
	{ "data\\MODEL\\StageObject\\IronBar.x"                   , "NONEDATA"                                       , Color(255,255,255,255), MODEL_TYPE::PUT          , SET_TYPE::NONE                ,  0.0f  , 0.0f , },	  // 鉄格子(当たり判定無し想定)
	{ "data\\MODEL\\StageObject\\IronBar1.x"                  , "NONEDATA"                                       , Color(255,255,255,255), MODEL_TYPE::PUT          , SET_TYPE::NONE                ,  0.0f  , 0.0f , },	  // 鉄格子1
	{ "data\\MODEL\\StageObject\\IronBar2.x"                  , "NONEDATA"                                       , Color(255,255,255,255), MODEL_TYPE::PUT          , SET_TYPE::NONE                ,  0.0f  , 0.0f , },	  // 鉄格子2
	{ "data\\MODEL\\StageObject\\IronBar3.x"                  , "NONEDATA"                                       , Color(255,255,255,255), MODEL_TYPE::PUT          , SET_TYPE::NONE                ,  0.0f  , 0.0f , },	  // 鉄格子3
	...
	{ "data\\MODEL\\StageObject\\SandAndAsphaltBlock.x"       , "NONEDATA"                                       , Color(255,255,255,255), MODEL_TYPE::PUT          , SET_TYPE::NONE                ,  0.0f  , 0.0f , },	  // 砂＆アスファルトブロック(中間用)
	{ "data\\MODEL\\StageObject\\SandBlock.x"                 , "NONEDATA"                                       , Color(255,255,255,255), MODEL_TYPE::PUT          , SET_TYPE::NONE                ,  0.0f  , 0.0f , },	  // 砂ブロック
	{ "data\\MODEL\\Torch.x"                                  , "NONEDATA"                                       , Color(255,255,255,255), MODEL_TYPE::PUT          , SET_TYPE::NONE                ,  0.0f  , 30.0f, },	  // 松明
	{ "data\\MODEL\\Snake.x"                                  , "NONEDATA"                                       , Color(255,255,255,255), MODEL_TYPE::PUT          , SET_TYPE::NONE                ,  0.0f  , 30.0f, },	  // 蛇の壁画
	{ "data\\MODEL\\leaf_large.x"                             , "NONEDATA"                                       , Color(255,255,255,255), MODEL_TYPE::PUT          , SET_TYPE::NONE                ,  0.0f  , 0.0f , },	  // 緑色の葉っぱ(大)
	{ "data\\MODEL\\leaf_small.x"                             , "NONEDATA"                                       , Color(255,255,255,255), MODEL_TYPE::PUT          , SET_TYPE::NONE                ,  0.0f  , 0.0f , },	  // 緑色の葉っぱ(小)
	{ "data\\MODEL\\dry-leaf_large.x"                         , "NONEDATA"                                       , Color(255,255,255,255), MODEL_TYPE::PUT          , SET_TYPE::NONE                ,  0.0f  , 0.0f , },	  // 茶色の葉っぱ(大)
	{ "data\\MODEL\\dry-leaf_small.x"                         , "NONEDATA"                                       , Color(255,255,255,255), MODEL_TYPE::PUT          , SET_TYPE::NONE                ,  0.0f  , 0.0f , },	  // 茶色の葉っぱ(小)
	{ "data\\MODEL\\StoneDragon.x"                            , "NONEDATA"                                       , Color(255,255,255,255), MODEL_TYPE::PUT          , SET_TYPE::NONE                ,  0.0f  , 30.0f, },	  // 龍の石像
	{ "data\\MODEL\\StoneSword.x"                             , "NONEDATA"                                       , Color(255,255,255,255), MODEL_TYPE::PUT          , SET_TYPE::NONE                ,  0.0f  , 30.0f, },	  // 剣の石像
	...
	{ "data\\MODEL\\sango_1.x"                                , "NONEDATA"                                       , Color(255,255,255,255), MODEL_TYPE::PUT          , SET_TYPE::NONE                , -12.0f , 30.0f, },	  // サンゴ礁1
	{ "data\\MODEL\\sango_2.x"                                , "NONEDATA"                                       , Color(255,255,255,255), MODEL_TYPE::PUT          , SET_TYPE::NONE                , -12.0f , 30.0f, },	  // サンゴ礁2
	{ "data\\MODEL\\sango_3.x"                                , "NONEDATA"                                       , Color(255,255,255,255), MODEL_TYPE::PUT          , SET_TYPE::NONE                , -8.0f  , 30.0f, },	  // サンゴ礁3
	{ "data\\MODEL\\stone_1.x"                                , "NONEDATA"                                       , Color(255,255,255,255), MODEL_TYPE::PUT          , SET_TYPE::NONE                ,  0.0f  , 30.0f, },	  // 岩1
	{ "data\\MODEL\\stone_2.x"                                , "NONEDATA"                                       , Color(255,255,255,255), MODEL_TYPE::PUT          , SET_TYPE::NONE                , -8.0f  , 30.0f, },	  // 岩2
	{ "data\\MODEL\\building000.x"                            , "NONEDATA"                                       , Color(255,255,255,255), MODEL_TYPE::PUT          , SET_TYPE::NONE                ,  0.0f  , 30.0f, },	  // 建物1
	{ "data\\MODEL\\building001.x"                            , "NONEDATA"                                       , Color(255,255,255,255), MODEL_TYPE::PUT          , SET_TYPE::NONE                ,  0.0f  , 30.0f, },	  // 建物2
};
