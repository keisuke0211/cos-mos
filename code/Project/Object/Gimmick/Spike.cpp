...
void CSpike::Update(void)
{
	...
	else
	{
		...
		Manager::EffectMgr()->ParticleCreate(m_nTex[RAND_TEX], m_TexPos,D3DXVECTOR3(ScaleTex, ScaleTex,0.0f), Color{ 255,0,255,255 }, CParticle::TYPE::TYPE_FLOATUP, 300,m_rot,D3DXVECTOR3(40.0f,40.0f,0.0f));
	}
}
