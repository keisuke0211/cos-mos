...
void CPile::CaveInTrunkHeight(float fCaveInHeight)
{
	...
	for (int Cnt = 0; Cnt < NumEffect; Cnt++){
		...
		Manager::EffectMgr()->ParticleCreate(m_nTex[RAND_TEX], TexPos, D3DXVECTOR3(ScaleTex, ScaleTex, 0.0f), Color{ 255,255,155,30 }, CParticle::TYPE::TYPE_FLOATUP, 300,rot, D3DXVECTOR3(80.0f, 80.0f, 0.0f),false,false,_RNC_DrawState::ALPHA_BLEND_MODE::NORMAL,16);
